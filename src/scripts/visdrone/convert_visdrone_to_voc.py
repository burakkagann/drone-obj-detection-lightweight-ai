...
The script handles both training and validation sets.
"""
...
class VisDroneToVOCConverter:
    def __init__(self):
        # Input directories
        self.input_labels_dir = r'data/my_dataset/visdrone/mobilenet-ssd/labels'
        self.input_images_dir = r'data/my_dataset/visdrone/images'
        
        # Output directories
        self.output_voc_dir = r'data/my_dataset/visdrone/mobilenet-ssd/voc_format'
    ...
    def convert_dataset(self):
        ...
        print("Converting VisDrone annotations to VOC format...")
