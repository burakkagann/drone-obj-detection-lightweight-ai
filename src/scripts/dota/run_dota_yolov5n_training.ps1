...
function Start-Venv {
    Write-Host "Starting YOLOv5 virtual environment for DOTA..."
    $env:VIRTUAL_ENV = "C:\Users\burak\OneDrive\Desktop\Git Repos\drone-obj-detection-lightweight-ai\venvs\yolov5_dota_env"  # Path to your YOLOv5 DOTA virtual environment
...
# Step 3: Function to train YOLOv5 on DOTA dataset
function Train-YOLOv5 {
    Write-Host "Starting YOLOv5 training on DOTA..."
    python ..\..\..\src\models\YOLOv5\train.py --img 640 --batch 16 --epochs 50 --data ..\..\..\config\dota.yaml --weights yolov5s.pt --name yolo_dota_baseline
}
